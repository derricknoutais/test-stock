...
@section('content')
    <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-mt-16">
        <h1 class="tw-text-6xl tw-tracking-widest tw-font-extrabold">SHIPPER NOVA</h1>
        ...
        <div class="tw-mt-20">
            ...
            <a href="/produitx" class="tw-mx-10 tw-text-lg  tw-tracking-wider tw-shadow-outline tw-p-5 tw-border-0 tw-rounded-lg">PRODUITS</a>
